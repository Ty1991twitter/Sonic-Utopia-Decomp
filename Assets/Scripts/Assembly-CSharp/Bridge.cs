...
public class Bridge : MonoBehaviour
{
	...
	[CompilerGenerated]
	private static Func<Collider, Character> _003C_003Ef__am_0024cacheE;

	[CompilerGenerated]
	private static Func<Character, bool> _003C_003Ef__am_0024cacheF;
	...
	private void Start()
	{
		...
		for (int i = 1; i < logAmount; i++)
		{
			...
			targetPos[i] = vector;
			logs[i] = (UnityEngine.Object.Instantiate(Resources.Load("Bridge Log", typeof(GameObject)), vector, start.rotation, base.transform) as GameObject).transform;
	...
	private void FixedUpdate()
	{
		...
		Collider[] source = Physics.OverlapBox(Vector3.Lerp(startPos, endPos, 0.5f), new Vector3(8f, 2f, logAmount), Quaternion.Euler(0f, start.rotation.eulerAngles.y, 0f));
		if (_003C_003Ef__am_0024cacheE == null)
		{
			_003C_003Ef__am_0024cacheE = _003CFixedUpdate_003Em__29;
		}
		IEnumerable<Character> source2 = source.Select(_003C_003Ef__am_0024cacheE);
		if (_003C_003Ef__am_0024cacheF == null)
		{
			_003C_003Ef__am_0024cacheF = _003CFixedUpdate_003Em__2A;
		}
		Character character = source2.FirstOrDefault(_003C_003Ef__am_0024cacheF);
		if (character != null)
		{
			lerp = 0f;
	...
	[CompilerGenerated]
	private static Character _003CFixedUpdate_003Em__29(Collider p)
	{
		return p.gameObject.GetComponent<Character>();
	}

	[CompilerGenerated]
	private static bool _003CFixedUpdate_003Em__2A(Character p)
	{
		return p != null;
	}
}
