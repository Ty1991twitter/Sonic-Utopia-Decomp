...
namespace PigeonCoopToolkit.Effects.Trails
{
	public abstract class TrailRenderer_Base : MonoBehaviour
	{
		...
		protected virtual void Update()
		{
			...
			{
				if (_fadingTrails[num] == null || !_fadingTrails[num].Points.Any(_003CUpdate_003Em__24))
				{
		...
		[CompilerGenerated]
		private bool _003CUpdate_003Em__24(PCTrailPoint a)
		{
			return a.TimeActive() < TrailData.Lifetime;
		}
	}
}
