...
namespace Sonic
{
	...
	public class Spindash : AbilityBehaviour
	{
		...
		public void ChargeSpindash(Ability o, float fCharge)
		{
			...
			SpecialEffectHandler specialEffectHandler = o.character.avatar.effectHandlers.Find(_003CChargeSpindash_003Em__25);
		...
		[CompilerGenerated]
		private bool _003CChargeSpindash_003Em__25(SpecialEffectHandler oH)
		{
			return oH.name == chargeEffectName;
		}
	}
}
